...
$(function(){
    ...
    $('#bet_cashout_button').click(function(){
        placeBet($('#cashout_input').val(), $('#bet_input').val(), 0.01, $('#bet_input').val());
    });
});
    ...
    getHash(function(){
        $.ajax({
            ...
            if(data.outcome >= rangeWin){ // loss
                $('#bet_cashout_button').text("Bet");
                $('#bet_cashout_button').click(function(){placeBet($('#cashout_input').val(), $('#bet_input').val(), 0.01, $('#bet_input').val());});
