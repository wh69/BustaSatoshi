...
$('#bet_cashout_button').click(function(){
    if(!user.connected){
        window.location.href = "https://www.moneypot.com/oauth/authorize?app_id=1280&response_type=token&state=Meh&redirect_uri=https://dexon95.github.io/bustasatoshi/";
        return;
    }
    if(betting){
        cashedOut = true;
